...
(If you're viewing this on the website, try clicking the icon buttons to filter the items in the list based on the category)

Throughout this list you'll see next to each resource an emoji. Here's what each means:
...
- :video_camera: [DevOps roadmap with Resources](https://youtube.com/watch?v=7l_n97Mt0ko&t=6s) <!-- Fixed missing : in YouTube URL -->
